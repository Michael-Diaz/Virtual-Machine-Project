...
void addToSymbolTable(int kind, int* tableIndexPointer, int* dataIndexPointer, int lexLevel, Symbol* table); //emit
...
void addToSymbolTable(int kind, int* tableIndexPointer, int* dataIndexPointer, int lexLevel, Symbol* symbolTable) //emit
{
  char* nameTemp;
  int i, strLength;
  (*tableIndexPointer)++;
...
void addToOutput(int op, int l, int m, Instruction* instructions) //emit
{
...
void main(int argc, int**argv)
{
  ...
  int i, lexLevel = 0, dataIndex = 0, tableIndex = 0;
  FILE* ifp;
  FILE* ofp;
